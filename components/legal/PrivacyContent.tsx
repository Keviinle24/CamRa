// Privacy policy text, shown on /privacy and in the sign-up/login modals.
    ...
    <div className="legal-content">
      ...
      <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to
          ...
          Policy has been created with the help of the <a
              href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank" rel="noopener noreferrer">Free
      ...
      <ul>
          ...
          <li>
              <p><strong>Website</strong> refers to Camra, accessible from <a href="https://camra.me" target="_blank" rel="noopener noreferrer">Camra.me</a>
              </p>
          </li>
          <li>
